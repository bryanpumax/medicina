...
$objPHPExcel->getActiveSheet()->setCellValue('C1', 'Informe diario');
...
->getStyle('f5:z5')->getAlignment()->setTextRotation(90);
...
$contarFila=6;
$queryVisita = $pdo->query("SELECT * FROM view_visitas where idx_operador=$id and fech_visita=curdate()"); //contenido
...
$objPHPExcel->getActiveSheet()->setTitle('Reporte diario_'.$fecha);
