...
$idx_operador= $_SESSION['idx_operador'];
    ...
    if (isset($id)) {
        ...
        $idcliente=$clientes['idx_clientes'];
$nom=($clientes['nom_clientes']) . ' ' . ($clientes['ape_clientes']) ;
$clientes['idx_clientes']=0;$clientes['nom_clientes']="";
$clientes['ape_clientes']="";
    } else {
    ...
    <div class="box dark">
        ...
        <!-- /.form-group -->
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    ...
                    <option value="'.$idcliente.'">'.$nom.'</option>
...
<td  class="mayuscula">' . ($tipo['cliente']) . '</td> 
<td  class="mayuscula">' . ($tipo['operador']) . '</td> 
';

if($tipo['estado_citas']=="activo"){

echo  '<td  class="alert alert-info bg-info text-white border-0 mayuscula"><span class="badge badge-danger">'. $tipo['estado_citas'] . '</span></td> ';
}

if($tipo['estado_citas']=="cumplida"){

    echo  '<td class=" alert alert-warning bg-warning text-white border-0 mayuscula"><span class="badge badge-succes">'. $tipo['estado_citas'] . '</span></td> ';
    };
