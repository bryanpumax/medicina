 ...
 *
 * This source fil
 * e is distributed in the hope that it will be useful, but
...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "lengthMenu": [[3,5, 15, 50, -1], [3, 15, 50, "All"]]
		 *      } );
		 *    } );
		 */
		"aLengthMenu": [ 3, 5, 15],
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Presentando _START_ hasta _END_ de _TOTAL_ registros
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "No hay informacion que presentar"
			 *        }
			 *      } );
			 *    } );
			 */
