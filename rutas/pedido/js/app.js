;(function (){
    ...
    $("#productoGuarda").on("click",function(){
        ...
        .done(function (data){
           ...
           $("#promo").val('')
           $("#iva").val('')
           $(".productos").load('detalles_pedido.php?id='+data)
        })
...
var codCotizacion= e.currentTarget.dataset.idcotizacion
var codProducto = e.currentTarget.dataset.idproducto

$.ajax({
    type:"POST",
    url:"php/eliminaItem.php",
    data:{codcotizacion:codCotizacion, codproducto:codProducto}

}).done(function(data){

    $(".productos").load('detalles_pedido.php?id='+codCotizacion)
